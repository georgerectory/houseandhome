...
const asBought = {
  ...
  features: [
    ...
    { id: 'porch', level: 'ground', room: 'hall', kind: 'porch', rect: [3.53, D_ENV, 4.50, 8.55], height: 2.30, roofKind: 'gabled', note: 'The small tiled gable canopy over the front door in the photograph.' },
  ],
};
...
const postExtension = {
  ...
  features: [
    ...
    { id: 'porch', level: 'ground', room: 'hall', kind: 'porch', rect: [3.53, D_ENV, 4.50, 8.55], height: 2.30, roofKind: 'gabled' },
  ],
};
